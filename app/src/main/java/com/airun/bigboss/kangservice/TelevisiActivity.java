...
public class TelevisiActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = "TelevisiActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etextmerk = (EditText) findViewById(R.id.etextmerktv);
        etextversi = (EditText) findViewById(R.id.etextversitv);
        etextkerusakan = (EditText) findViewById(R.id.etextkerusakantv);
        imagekerusakan = (ImageView) findViewById(R.id.upgambarpc);
    ...
    private void sendRequest() {
        ...
        if (Rmerk.isEmpty()) {
            prodialog.dismiss();
            etextmerk.setError("Harap masukkan merk tv");
        ...
        }).addOnCompleteListener(new OnCompleteListener<Uri>()
        {
            ...
            public void onComplete(@NonNull Task<Uri> task)
            {
                if (task.isSuccessful())
                {
                    ...
                    Intent intent = new Intent(TelevisiActivity.this, MainActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);
                } else
                {
                    prodialog.dismiss();
                    Toast.makeText(TelevisiActivity.this, "Request Gagal : " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
