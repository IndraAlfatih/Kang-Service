...
public class KomputerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_pc);
        ...
        etextmerk = (EditText) findViewById(R.id.etextkomponen);
        etextversi = (EditText) findViewById(R.id.etextversipc);
        etextkerusakan = (EditText) findViewById(R.id.etextkerusakanpc);
    ...
    private void sendRequest() {
        ...
        if (Rmerk.isEmpty()) {
            prodialog.dismiss();
            etextmerk.setError("Harap masukkan merk komponen pc");
        ...
        }).addOnCompleteListener(new OnCompleteListener<Uri>()
        {
            ...
            public void onComplete(@NonNull Task<Uri> task)
            {
                if (task.isSuccessful())
                {
                    ...
                    Intent intent = new Intent(KomputerActivity.this, MainActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);
                } else
                {
                    prodialog.dismiss();
                    Toast.makeText(KomputerActivity.this, "Request Gagal : " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
