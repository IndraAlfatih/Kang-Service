...
public class LaptopActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etextmerk = (EditText) findViewById(R.id.etextmerklaptop);
        etextversi = (EditText) findViewById(R.id.etextversilaptop);
        etextkerusakan = (EditText) findViewById(R.id.deskripsilaptop);
        imagekerusakan = (ImageView) findViewById(R.id.upgambar1);
    ...
    private void sendRequest() {
        ...
        if (Rmerk.isEmpty()) {
            prodialog.dismiss();
            etextmerk.setError("Harap masukkan merk laptop");
        ...
        if (Rversi.isEmpty()) {
            prodialog.dismiss();
            etextversi.setError("Harap masukkan versi laptop");
        ...
        }).addOnCompleteListener(new OnCompleteListener<Uri>()
        {
            ...
            public void onComplete(@NonNull Task<Uri> task)
            {
                ...
                {
                    prodialog.dismiss();
                    Toast.makeText(LaptopActivity.this, "Request Gagal : " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
