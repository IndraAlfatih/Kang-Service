...
public class AndroidActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etextmerk = (EditText) findViewById(R.id.etextmerkhp);
        etextversi = (EditText) findViewById(R.id.etextversihp);
        etextkerusakan = (EditText) findViewById(R.id.etextkerusakan);
        imagekerusakan = (ImageView) findViewById(R.id.upgambar);
        box1 = (CheckBox) findViewById(R.id.chkBox1);
        Spinner myspinner = (Spinner) findViewById(R.id.buttonpilihkang);
        ...
        ArrayAdapter<String> myadapter = new ArrayAdapter<String>(AndroidActivity.this,
                android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.kangservice));
    ...
    private void sendRequest() {
            ...
            if (Rmerk.isEmpty()) {
                prodialog.dismiss();
                etextmerk.setError("Harap masukkan merk hp");
            ...
            if (Rversi.isEmpty()) {
                prodialog.dismiss();
                etextversi.setError("Harap masukkan versi hp");
                etextversi.requestFocus();
                return;
            }
        ...
        }).addOnCompleteListener(new OnCompleteListener<Uri>()
        {
            ...
            public void onComplete(@NonNull Task<Uri> task)
            {
                ...
                {
                    prodialog.dismiss();
                    Toast.makeText(AndroidActivity.this, "Request Gagal : " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
