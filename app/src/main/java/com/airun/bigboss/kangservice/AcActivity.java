...
public class AcActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_ac);
        ...
        etextmerk = (EditText) findViewById(R.id.etextmerkac);
        etextversi = (EditText) findViewById(R.id.etextversiac);
        etextkerusakan = (EditText) findViewById(R.id.etextkerusakanac);
        imagekerusakan = (ImageView) findViewById(R.id.upgambar2);
    ...
    private void sendRequest() {
        ...
        if (Rmerk.isEmpty()) {
            prodialog.dismiss();
            etextmerk.setError("Harap masukkan merk ac");
        ...
        }).addOnCompleteListener(new OnCompleteListener<Uri>()
        {
            ...
            public void onComplete(@NonNull Task<Uri> task)
            {
                ...
                {
                    prodialog.dismiss();
                    Toast.makeText(AcActivity.this, "Request gagal : " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
